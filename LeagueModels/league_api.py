...
#TODO: need to ensure I grab matches that are in the top 100 for ALL of us
    ...
    def get_recap_history(self, summoner_name:str, champ_name: str):  #-> discord.Embed: Not working?
        ...
        summoner = cass.Summoner(region=cass.Region.north_america, name=summoner_name)
        ...
        embed.set_thumbnail(url=profile_pic.url)
        ...
        sorted_items = set()
        sorted_items.add([item for item in items if 'Mythic' in item][0])
