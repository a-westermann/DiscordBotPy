...
class BabyView(discord.ui.View):
    ...
    async def one(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.score, self.baby_name = 1
        print("scored 1")
        button.callback = await self.baby.submit_name_score(self.score, self.baby_name, interaction)
        self.stop()

    @discord.ui.button(label="2", style=discord.ButtonStyle.red)
    async def two(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.score, self.baby_name = 2
        print("scored 2")
        button.callback = await self.baby.submit_name_score(self.score, self.baby_name, interaction)
        self.stop()
